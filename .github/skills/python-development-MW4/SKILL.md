...
9. as last step before completion the overall packge will be tested
...
14. type annotations should be used for all functions and methods, including return types
