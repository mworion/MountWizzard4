...
10.12 to 26.x) and Linux (Ubuntu from 16.04 to 26.04). If you have some knowledge
...
Known limitations
=================
MountWizzard4 v4 does support python 3.11 - 3.14 right now. The reason for that
