        ...
        self.dataPlots = {
            ...
            'Temperature': {
                'gen': {'range': (-20, 40, False),
                        'leg': None,
                        'label': 'Temperature [°C]'},
                'sensor1WeatherTemp': {'pd': None,
                                       'name': 'Sensor 1',
                                       'pen': self.M_GREEN},
                'sensor2WeatherTemp': {'pd': None,
                                       'name': 'Sensor 2',
                                       'pen': self.M_RED},
                'sensor3WeatherTemp': {'pd': None,
                                       'name': 'Sensor 3',
                                       'pen': self.M_PINK},
            ...
            'Dew Temperature': {
                ...
                'sensor1WeatherDew': {'pd': None,
                                      'name': 'Sensor 1',
                                      'pen': self.M_GREEN},
                'sensor2WeatherDew': {'pd': None,
                                      'name': 'Sensor 2',
                                      'pen': self.M_RED},
                'sensor3WeatherDew': {'pd': None,
                                      'name': 'Sensor 3',
                                      'pen': self.M_PINK},
            ...
            'Pressure': {
                'gen': {'range': (900, 1050, False),
                        'leg': None,
                        'label': 'Pressure [hPa]'},
                'sensor1WeatherPress': {'pd': None,
                                        'name': 'Sensor 1',
                                        'pen': self.M_GREEN},
                'sensor2WeatherPress': {'pd': None,
                                        'name': 'Sensor 2',
                                        'pen': self.M_RED},
                'sensor3WeatherPress': {'pd': None,
                                        'name': 'Sensor 3',
                                        'pen': self.M_PINK},
            ...
            'Humidity': {
                'gen': {'range': (-5, 105, True),
                        'leg': None,
                        'label': 'Humidity [%]'},
                'sensor1WeatherHum': {'pd': None,
                                      'name': 'Sensor 1',
                                      'pen': self.M_GREEN},
                'sensor2WeatherHum': {'pd': None,
                                      'name': 'Sensor 2',
                                      'pen': self.M_RED},
                'sensor3WeatherHum': {'pd': None,
                                      'name': 'Sensor 3',
                                      'pen': self.M_PINK},
            ...
            'Sky Quality': {
                ...
                'sensor1WeatherSky': {'pd': None,
                                      'name': 'Sensor 1',
                                      'pen': self.M_GREEN},
                'sensor2WeatherSky': {'pd': None,
                                      'name': 'Sensor 2',
                                      'pen': self.M_RED},
                'sensor3WeatherSky': {'pd': None,
                                      'name': 'Sensor 3',
                                      'pen': self.M_PINK},
                'onlineWeatherHum': {'pd': None,
                                     'name': 'Online',
