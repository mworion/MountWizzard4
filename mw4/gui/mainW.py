...
class MainWindow(MWidget,
    ...
    def setupIcons(self):
        ...
        self.wIcon(self.ui.moveNorth, PyQt5.QtGui.QIcon(':/icon/play_m.svg'))
        self.wIcon(self.ui.moveEast, PyQt5.QtGui.QIcon(':/icon/play_m.svg'))
        self.wIcon(self.ui.moveSouth, PyQt5.QtGui.QIcon(':/icon/play_m.svg'))
        self.wIcon(self.ui.moveWest, PyQt5.QtGui.QIcon(':/icon/play_m.svg'))
        self.wIcon(self.ui.moveNorthEast, PyQt5.QtGui.QIcon(':/icon/play_m.svg'))
        self.wIcon(self.ui.moveNorthWest, PyQt5.QtGui.QIcon(':/icon/play_m.svg'))
        self.wIcon(self.ui.moveSouthEast, PyQt5.QtGui.QIcon(':/icon/play_m.svg'))
        self.wIcon(self.ui.moveSouthWest, PyQt5.QtGui.QIcon(':/icon/play_m.svg'))
        self.wIcon(self.ui.stopMoveAll, PyQt5.QtGui.QIcon(':/icon/stop_m.svg'))
