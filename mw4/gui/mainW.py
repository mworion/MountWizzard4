...
class MainWindow(MWidget,
    ...
    def setupIcons(self):
        ...
        # self.wIcon(self.ui.moveNorth, QIcon(':/icon/play_m.svg'))
        # self.wIcon(self.ui.moveEast, QIcon(':/icon/play_m.svg'))
        # self.wIcon(self.ui.moveSouth, QIcon(':/icon/play_m.svg'))
        # self.wIcon(self.ui.moveWest, QIcon(':/icon/play_m.svg'))
        # self.wIcon(self.ui.moveNorthEast, QIcon(':/icon/play_m.svg'))
        # self.wIcon(self.ui.moveNorthWest, QIcon(':/icon/play_m.svg'))
        # self.wIcon(self.ui.moveSouthEast, QIcon(':/icon/play_m.svg'))
        # self.wIcon(self.ui.moveSouthWest, QIcon(':/icon/play_m.svg'))
