...
class MainWindow(
    ...
    def smartFunctionGui(self):
        ...
        if isMountReady:
            ...
            self.ui.progSatellitesFull.setEnabled(True)
            self.ui.progSatellitesFiltered.setEnabled(True)
            self.ui.progMinorPlanetsFull.setEnabled(True)
            ...
            self.ui.progSatellitesFull.setEnabled(False)
            self.ui.progSatellitesFiltered.setEnabled(False)
            self.ui.progMinorPlanetsFull.setEnabled(False)
