...
class SettMisc(object):
    ...
    def initConfig(self):
        ...
        self.ui.satTimeUTC.setChecked(config.get('satTimeUTC', True))
        self.ui.satTimeLocal.setChecked(config.get('satTimeLocal', False))
    ...
    def storeConfig(self):
        ...
        config['satTimeUTC'] = self.ui.satTimeUTC.isChecked()
        config['satTimeLocal'] = self.ui.satTimeLocal.isChecked()
