...
class Ui_AnalyseDialog(object):
    def setupUi(self, AnalyseDialog):
        ...
        self.eposure = QLineEdit(self.groupBox_5)
        self.eposure.setObjectName(u"eposure")
        self.eposure.setEnabled(True)
        self.eposure.setMinimumSize(QSize(25, 0))
...
#if QT_CONFIG(tooltip)
        self.eposure.setToolTip(QCoreApplication.translate("AnalyseDialog", u"Name of Model Points file, where the data is stored. ", None))
#endif // QT_CONFIG(tooltip)
