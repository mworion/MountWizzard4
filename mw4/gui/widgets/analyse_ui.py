...
class Ui_AnalyseDialog(object):
    def setupUi(self, AnalyseDialog):
        ...
        self.modelOrthoError.setAlignment(
            Qt.AlignmentFlag.AlignRight
            | Qt.AlignmentFlag.AlignTrailing
            | Qt.AlignmentFlag.AlignVCenter
        )
        ...
        self.modelErrorRMS.setAlignment(
            Qt.AlignmentFlag.AlignRight
            | Qt.AlignmentFlag.AlignTrailing
            | Qt.AlignmentFlag.AlignVCenter
        )
        ...
        self.modelPolarError.setAlignment(
            Qt.AlignmentFlag.AlignRight
            | Qt.AlignmentFlag.AlignTrailing
            | Qt.AlignmentFlag.AlignVCenter
        )
        ...
        self.exposureTime.setAlignment(
            Qt.AlignmentFlag.AlignRight
            | Qt.AlignmentFlag.AlignTrailing
            | Qt.AlignmentFlag.AlignVCenter
        )
    ...
    def retranslateUi(self, AnalyseDialog):
        AnalyseDialog.setWindowTitle(
            QCoreApplication.translate("AnalyseDialog", "Analyse Model", None)
        )
        ...
        self.profile.setToolTip(
            QCoreApplication.translate(
                "AnalyseDialog", "Name of Model Points file, where the data is stored. ", None
            )
        )
        ...
        # if QT_CONFIG(tooltip)
        self.modelOrthoError.setToolTip(
            QCoreApplication.translate(
                "AnalyseDialog", "Name of Model Points file, where the data is stored. ", None
            )
        )
        ...
        # if QT_CONFIG(tooltip)
        self.modelPolarError.setToolTip(
            QCoreApplication.translate(
                "AnalyseDialog", "Name of Model Points file, where the data is stored. ", None
            )
        )
        ...
        self.label_6.setText(QCoreApplication.translate("AnalyseDialog", "Build", None))
        # if QT_CONFIG(tooltip)
        self.totalPoints.setToolTip(
            QCoreApplication.translate(
                "AnalyseDialog", "Name of Model Points file, where the data is stored. ", None
            )
        )
        ...
        self.groupBox_15.setTitle(
            QCoreApplication.translate(
                "AnalyseDialog", "Model point errors in ascending order", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        self.tabWidget.setTabText(
            ...
            QCoreApplication.translate("AnalyseDialog", "General Analyse", None),
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate(
                "AnalyseDialog", "RA Raw Error (PlateSolve Result, w/o Model)", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        self.groupBox_7.setTitle(
            QCoreApplication.translate(
                "AnalyseDialog", "DEC Raw Error (PlateSolve Result, w/o Model)", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        self.groupBox_8.setTitle(
            QCoreApplication.translate("AnalyseDialog", "RA Error (with Model)", None)
        )
        # if QT_CONFIG(tooltip)
        self.raErrors.setToolTip("")
        # endif // QT_CONFIG(tooltip)
        self.groupBox_9.setTitle(
            QCoreApplication.translate("AnalyseDialog", "DEC Error (with Model)", None)
        )
        # if QT_CONFIG(tooltip)
        self.decErrors.setToolTip("")
        # endif // QT_CONFIG(tooltip)
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.AltAz),
            QCoreApplication.translate("AnalyseDialog", "Alt / Az Analyse", None),
        )
        ...
        # endif // QT_CONFIG(tooltip)
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.RaDec),
            QCoreApplication.translate("AnalyseDialog", "RA / DEC Analyse", None),
        )
