...
class Ui_HemisphereDialog(object):
    ...
    def retranslateUi(self, HemisphereDialog):
        HemisphereDialog.setWindowTitle(
            QCoreApplication.translate("HemisphereDialog", "Hemisphere", None)
        )
        self.operationModeGroup.setTitle(
            QCoreApplication.translate("HemisphereDialog", "Operation Mode", None)
        )
        # if QT_CONFIG(tooltip)
        self.normalModeHem.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog", "Switching the hemisphere window to normal working mode.", None
            )
        )
        ...
        self.editModeHem.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog", "Enabling the edit mode for model build points.", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.editModeHem.setText(
            QCoreApplication.translate("HemisphereDialog", "Edit Model", None)
        )
        # if QT_CONFIG(tooltip)
        self.alignmentModeHem.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Enabling the polar or ortho align procedure. For starting the procedure, enable align stars and choose a polar align star with mouse double click and chose the type of alignment.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.alignmentModeHem.setText(
            QCoreApplication.translate("HemisphereDialog", "Polar / Otho Align", None)
        )
        # if QT_CONFIG(tooltip)
        self.groupBox_3.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog", "Showing different elements on the hemisphere diagram.", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.groupBox_3.setTitle(
            QCoreApplication.translate("HemisphereDialog", "Show Elements", None)
        )
        # if QT_CONFIG(tooltip)
        self.showCelestial.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Show the celestial circles in the view</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.showCelestial.setText(
            QCoreApplication.translate("HemisphereDialog", "Celestial paths ", None)
        )
        # if QT_CONFIG(tooltip)
        self.showMountLimits.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Show the mount limits</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.showMountLimits.setText(
            QCoreApplication.translate("HemisphereDialog", "Mount limits ", None)
        )
        # if QT_CONFIG(tooltip)
        self.showAlignStar.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Show the align stars in horizin view</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.showAlignStar.setText(
            QCoreApplication.translate("HemisphereDialog", "Align stars ", None)
        )
        # if QT_CONFIG(tooltip)
        self.showPolar.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Show an additional polar diagram on right side in hemisphere view</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.showSlewPath.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Show the slew path of the mount</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.showSlewPath.setText(
            QCoreApplication.translate("HemisphereDialog", "Slew path ", None)
        )
        # if QT_CONFIG(tooltip)
        self.showTerrain.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Show the terrain image in background</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.showHorizon.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Use horizon mask in hemisphere window.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.showHorizon.setText(
            QCoreApplication.translate("HemisphereDialog", "Horizon mask ", None)
        )
        # if QT_CONFIG(tooltip)
        self.showIsoModel.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Showing the actual used mount model as reference.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.showIsoModel.setText(
            QCoreApplication.translate("HemisphereDialog", "Model Error", None)
        )
        ...
        self.terrainImageGroup.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Adjusting the terrain image to view</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.groupBox_4.setTitle(
            QCoreApplication.translate("HemisphereDialog", "Horizon Positions", None)
        )
        # if QT_CONFIG(tooltip)
        self.normalModeHor.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Switching the horizon view to normal working mode.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.editModeHor.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Enabling the edit mode for horizon mask.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.editModeHor.setText(
            QCoreApplication.translate("HemisphereDialog", "Edit Horizon", None)
        )
        # if QT_CONFIG(tooltip)
        self.addPositionToHorizon.setToolTip(
            QCoreApplication.translate(
                "HemisphereDialog",
                "<html><head/><body><p>Add actual telescope position (Alt/Az) as point to the horizon.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.addPositionToHorizon.setText(
            QCoreApplication.translate("HemisphereDialog", "Add actual pos", None)
        )
        ...
        self.clearHorizonMask.setText(
            QCoreApplication.translate("HemisphereDialog", "Clear ", None)
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.HorizonTab),
            QCoreApplication.translate(
                "HemisphereDialog", "Define Horizon Mask and Terrain Image", None
            ),
        )
