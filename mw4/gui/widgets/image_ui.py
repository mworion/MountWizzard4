...
class Ui_ImageDialog(object):
    def setupUi(self, ImageDialog):
        ...
        self.expTime.setGeometry(QtCore.QRect(175, 60, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.dec.setGeometry(QtCore.QRect(90, 30, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_30.setGeometry(QtCore.QRect(90, 15, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.label.setGeometry(QtCore.QRect(175, 45, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.label_33.setGeometry(QtCore.QRect(90, 45, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.rotation.setGeometry(QtCore.QRect(90, 60, 81, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
