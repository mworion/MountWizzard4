...
class Ui_ImageDialog(object):
    def setupUi(self, ImageDialog):
        ...
        self.decMouse.setObjectName(u"decMouse")
        ...
        self.decMouseFloat.setObjectName(u"decMouseFloat")
        ...
        self.raMouse.setObjectName(u"raMouse")
        ...
        self.raMouseFloat.setObjectName(u"raMouseFloat")
    ...
    def retranslateUi(self, ImageDialog):
        ...
        self.groupMouseCoord.setTitle(QCoreApplication.translate("ImageDialog", u"Mouse Coords", None))
        self.label_25.setText(QCoreApplication.translate("ImageDialog", u"RA [hours]", None))
        self.label_26.setText(QCoreApplication.translate("ImageDialog", u"DEC [deg]", None))
    # retranslateUi
