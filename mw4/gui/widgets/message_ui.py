...
class Ui_MessageDialog(object):
    def setupUi(self, MessageDialog):
        ...
        self.clear = QtWidgets.QPushButton(parent=MessageDialog)
        ...
        self.line = QtWidgets.QFrame(parent=MessageDialog)
        ...
        self.messageTable = QtWidgets.QTableWidget(parent=MessageDialog)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(False)
        self.messageTable.setFont(font)
        self.messageTable.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        ...
        self.messageTable.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.NoSelection)
        ...
        self.messageTable.setGridStyle(QtCore.Qt.PenStyle.DotLine)
