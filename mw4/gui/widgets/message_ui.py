...
class Ui_MessageDialog(object):
    def setupUi(self, MessageDialog):
        ...
        self.messageTable.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.messageTable.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectItems)
        self.messageTable.setShowGrid(False)
        self.messageTable.setGridStyle(QtCore.Qt.NoPen)
