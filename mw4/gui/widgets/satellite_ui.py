...
class Ui_SatelliteDialog(object):
    def setupUi(self, SatelliteDialog):
        ...
        self.horizontalSpacer_5 = QSpacerItem(
            70, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
    ...
    def retranslateUi(self, SatelliteDialog):
        ...
        self.label_335.setText(QCoreApplication.translate("SatelliteDialog", "\u00b0", None))
        self.label_239.setText(QCoreApplication.translate("SatelliteDialog", "Azimuth", None))
        # if QT_CONFIG(tooltip)
        ...
        self.label_209.setText(QCoreApplication.translate("SatelliteDialog", "\u00b0", None))
        # if QT_CONFIG(tooltip)
        ...
        self.label_298.setText(QCoreApplication.translate("SatelliteDialog", "Altitude", None))
        self.label_206.setText(QCoreApplication.translate("SatelliteDialog", "\u00b0", None))
        # if QT_CONFIG(tooltip)
