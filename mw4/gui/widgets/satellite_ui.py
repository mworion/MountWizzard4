...
class Ui_SatelliteDialog(object):
    def setupUi(self, SatelliteDialog):
        ...
        self.label_273 = QtWidgets.QLabel(parent=SatelliteDialog)
        ...
        self.satLatitude = QtWidgets.QLineEdit(parent=SatelliteDialog)
        ...
        self.satLatitude.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.satLatitude.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.label_330 = QtWidgets.QLabel(parent=SatelliteDialog)
        ...
        self.label_330.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.label_333 = QtWidgets.QLabel(parent=SatelliteDialog)
        ...
        self.satLongitude = QtWidgets.QLineEdit(parent=SatelliteDialog)
        ...
        self.satLongitude.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.satLongitude.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.label_205 = QtWidgets.QLabel(parent=SatelliteDialog)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(False)
        self.label_205.setFont(font)
        self.label_205.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.label_238 = QtWidgets.QLabel(parent=SatelliteDialog)
        ...
        self.satAzimuth = QtWidgets.QLineEdit(parent=SatelliteDialog)
        ...
        self.satAzimuth.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.satAzimuth.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.label_208 = QtWidgets.QLabel(parent=SatelliteDialog)
        ...
        self.label_297 = QtWidgets.QLabel(parent=SatelliteDialog)
        ...
        self.satAltitude = QtWidgets.QLineEdit(parent=SatelliteDialog)
        ...
        self.satAltitude.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.satAltitude.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.label_331 = QtWidgets.QLabel(parent=SatelliteDialog)
        ...
        self.label_331.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.groupEarth = QtWidgets.QGroupBox(parent=SatelliteDialog)
        ...
        self.satEarth = PlotBase(parent=self.groupEarth)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.groupHorizon = QtWidgets.QGroupBox(parent=SatelliteDialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.satHorizon = PlotBase(parent=self.groupHorizon)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
