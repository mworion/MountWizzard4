...
class Ui_SimulatorDialog(object):
    ...
    def retranslateUi(self, SimulatorDialog):
        SimulatorDialog.setWindowTitle(
            QCoreApplication.translate("SimulatorDialog", "Mount Simulation View", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("SimulatorDialog", "Show Settings", None)
        )
        # if QT_CONFIG(tooltip)
        self.domeTransparent.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>Show dome transparent.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.domeTransparent.setText(
            QCoreApplication.translate("SimulatorDialog", "Dome transp.", None)
        )
        # if QT_CONFIG(tooltip)
        self.showPointer.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>Show intersection point from line of sight and dome sphere.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.showPointer.setText(
            QCoreApplication.translate("SimulatorDialog", "Intersect Point", None)
        )
        # if QT_CONFIG(tooltip)
        self.showLaser.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>Show line of sight from telescope.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.showBuildPoints.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>Show build points on outer sphere.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.showBuildPoints.setText(
            QCoreApplication.translate("SimulatorDialog", "Build Points", None)
        )
        # if QT_CONFIG(tooltip)
        self.showNumbers.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>Show build point number close to build point.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.showSlewPath.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>Show slew path between build points.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.showHorizon.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>Show horizon in scene.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.topView.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>When pressed, show top view of scene.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.topWestView.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>When pressed, show view from top west to telecope scene.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.topWestView.setText(
            QCoreApplication.translate("SimulatorDialog", "Top West View", None)
        )
        # if QT_CONFIG(tooltip)
        self.westView.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>When pressed, show view from west to telecope scene.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.topEastView.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>When pressed, show view from top east to telecope scene.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.topEastView.setText(
            QCoreApplication.translate("SimulatorDialog", "Top East View", None)
        )
        # if QT_CONFIG(tooltip)
        self.eastView.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>When pressed, show view from east to telecope scene.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        ...
        self.telescopeView.setToolTip(
            QCoreApplication.translate(
                "SimulatorDialog",
                "<html><head/><body><p>When pressed, show view from telecope to sphere.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.telescopeView.setText(
            QCoreApplication.translate("SimulatorDialog", "Telescope View", None)
        )
        self.label.setText(QCoreApplication.translate("SimulatorDialog", "Light", None))
