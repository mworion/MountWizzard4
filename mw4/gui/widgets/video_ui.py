...
class Ui_VideoDialog(object):
    ...
    def retranslateUi(self, VideoDialog):
        ...
        self.videoSource.setItemText(3, QCoreApplication.translate("VideoDialog", u"Camera 1", None))
        self.videoSource.setItemText(4, QCoreApplication.translate("VideoDialog", u"Camera 2", None))
        self.videoSource.setItemText(5, QCoreApplication.translate("VideoDialog", u"Camera 3", None))
        self.videoSource.setItemText(6, QCoreApplication.translate("VideoDialog", u"Camera 4", None))
