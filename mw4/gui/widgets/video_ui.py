...
class Ui_VideoDialog(object):
    ...
    def retranslateUi(self, VideoDialog):
        VideoDialog.setWindowTitle(
            QCoreApplication.translate("VideoDialog", "Video Streams", None)
        )
        self.videoSource.setItemText(
            0, QCoreApplication.translate("VideoDialog", "RTSP Stream", None)
        )
        self.videoSource.setItemText(
            1, QCoreApplication.translate("VideoDialog", "HTTP Stream", None)
        )
        self.videoSource.setItemText(
            2, QCoreApplication.translate("VideoDialog", "HTTPS Stream", None)
        )
        self.videoSource.setItemText(3, QCoreApplication.translate("VideoDialog", "URL", None))
        self.videoSource.setItemText(
            4, QCoreApplication.translate("VideoDialog", "Camera 1", None)
        )
        self.videoSource.setItemText(
            5, QCoreApplication.translate("VideoDialog", "Camera 2", None)
        )
        self.videoSource.setItemText(
            6, QCoreApplication.translate("VideoDialog", "Camera 3", None)
        )
        self.videoSource.setItemText(
            7, QCoreApplication.translate("VideoDialog", "Camera 4", None)
        )
        ...
        self.videoURL.setToolTip(
            QCoreApplication.translate(
                "VideoDialog",
                "<html><head/><body><p>Please enter source here. If you have and rtsp url, please leave rtsp:// out, but add the right port if needed.</p></body></html>",
                None,
            )
        )
