...
class Ui_VideoDialog(object):
    ...
    def retranslateUi(self, VideoDialog):
        ...
        self.videoSource.setItemText(
            3, QCoreApplication.translate("VideoDialog", "Camera 1", None)
        )
        self.videoSource.setItemText(
            4, QCoreApplication.translate("VideoDialog", "Camera 2", None)
        )
        self.videoSource.setItemText(
            5, QCoreApplication.translate("VideoDialog", "Camera 3", None)
        )
        self.videoSource.setItemText(
