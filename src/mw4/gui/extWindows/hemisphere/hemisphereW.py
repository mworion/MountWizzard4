...
class HemisphereWindow(MWidget):
    ...
    def drawMeridianLimits(self, plotItem: pg.PlotItem) -> None:
        slew = self.app.dReg.drivers["mount"]["class"].setting.meridianLimitSlew
        track = self.app.dReg.drivers["mount"]["class"].setting.meridianLimitTrack
    ...
    def drawHorizonLimits(self, plotItem: pg.PlotItem) -> None:
        high = self.app.dReg.drivers["mount"]["class"].setting.horizonLimitHigh
        low = self.app.dReg.drivers["mount"]["class"].setting.horizonLimitLow
