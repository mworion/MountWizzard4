...
class Materials(Styles):
    ...
    def __init__(self):
        ...
        self.pointsRed.setAmbient(QColor(self.M_RED))
        self.pointsRed.setDiffuse(QColor(self.M_RED))
        self.pointsRed.setSpecular(QColor(self.M_RED))
        self.pointsRed.setShininess(64)

        self.pointsGreen = Qt3DExtras.QPhongMaterial()
        self.pointsGreen.setAmbient(QColor(self.M_GREEN))
        self.pointsGreen.setDiffuse(QColor(self.M_GREEN))
        self.pointsGreen.setSpecular(QColor(self.M_GREEN))
        self.pointsGreen.setShininess(64)

        self.points = Qt3DExtras.QPhongMaterial()
        self.points.setAmbient(QColor(self.M_TER))
        self.points.setDiffuse(QColor(self.M_TER))
        self.points.setSpecular(QColor(self.M_TER))
        self.points.setShininess(64)

        self.lines = Qt3DExtras.QPhongMaterial()
        self.lines.setAmbient(QColor(self.M_GRAY))
        self.lines.setDiffuse(QColor(self.M_GRAY))
        self.lines.setSpecular(QColor(self.M_GRAY))
