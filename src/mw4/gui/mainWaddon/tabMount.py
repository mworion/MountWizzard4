...
class Mount:
    ...
    def setLunarTracking(self) -> None:
        if self.app.dReg.drivers["mount"]["class"].setting.setLunarTracking():
    ...
    def setSiderealTracking(self) -> None:
        if self.app.dReg.drivers["mount"]["class"].setting.setSiderealTracking():
    ...
    def setSolarTracking(self) -> None:
        if self.app.dReg.drivers["mount"]["class"].setting.setSolarTracking():
    ...
    def flipMount(self) -> None:
        if self.app.dReg.drivers["mount"]["class"].obsSite.flip():
    ...
    def stop(self) -> None:
        if self.app.dReg.drivers["mount"]["class"].obsSite.stop():
