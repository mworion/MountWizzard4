...
class SettDome:
    ...
    def switchGeometryDefinition(self) -> None:
        ...
        is10Micron = self.ui.use10micronDef.isChecked()
        if is10Micron:
            self.ui.domeNorthOffset.setValue(self.app.dReg["mount"].instance.geometry.offNorth)
            self.ui.domeEastOffset.setValue(self.app.dReg["mount"].instance.geometry.offEast)
            self.ui.domeVerticalOffset.setValue(self.app.dReg["mount"].instance.geometry.offVert)
        else:
            self.ui.domeNorthOffset.setValue(self.app.dReg["mount"].instance.geometry.offNorthGEM)
            self.ui.domeEastOffset.setValue(self.app.dReg["mount"].instance.geometry.offEastGEM)
            self.ui.domeVerticalOffset.setValue(self.app.dReg["mount"].instance.geometry.offVertGEM)
        self.ui.domeEastOffset.valueChanged.connect(self.setUseGeometry)
        self.ui.domeNorthOffset.valueChanged.connect(self.setUseGeometry)
        self.ui.domeVerticalOffset.valueChanged.connect(self.setUseGeometry)
