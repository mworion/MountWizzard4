...
class SettDome:
    ...
    def setUseGeometry(self) -> None:
        ...
        self.app.dReg.drivers["dome"]["class"].useDynamicFollowing = useDynamicFollowing
        self.app.dReg.drivers["dome"]["class"].overshoot = self.ui.useOvershoot.isChecked()
        self.app.updateDomeSettings.emit()

    def setDomeSettlingTime(self) -> None:
        self.app.dReg.drivers["dome"]["class"].settlingTime = self.ui.settleTimeDome.value()
