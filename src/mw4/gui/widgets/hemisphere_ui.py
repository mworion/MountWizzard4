...
class Ui_HemisphereDialog(object):
    def setupUi(self, HemisphereDialog):
        ...
        HemisphereDialog.setMinimumSize(QSize(0, 0))
        HemisphereDialog.setMaximumSize(QSize(16777215, 16777215))
    ...
    def retranslateUi(self, HemisphereDialog):
        ...
        self.normalModeHem.setToolTip(QCoreApplication.translate("HemisphereDialog", u"<html><head/><body><p>Switching the hemisphere window to normal working mode.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.normalModeHem.setText(QCoreApplication.translate("HemisphereDialog", u"Normal", None))
#if QT_CONFIG(tooltip)
        self.editModeHem.setToolTip(QCoreApplication.translate("HemisphereDialog", u"<html><head/><body><p>Enabling the edit mode for model build points.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.groupBox_3.setToolTip(QCoreApplication.translate("HemisphereDialog", u"<html><head/><body><p>Showing different elements on the hemisphere diagram.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
