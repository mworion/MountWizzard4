...
class Ui_KeypadDialog(object):
    def setupUi(self, KeypadDialog):
        ...
        KeypadDialog.setMinimumSize(QSize(270, 580))
        ...
        sizePolicy2.setHeightForWidth(self.bdown.sizePolicy().hasHeightForWidth())
        self.bdown.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.bup.sizePolicy().hasHeightForWidth())
        self.bup.setSizePolicy(sizePolicy2)
