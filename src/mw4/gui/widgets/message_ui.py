...
class Ui_MessageDialog(object):
    def setupUi(self, MessageDialog):
        ...
        self.messageTable.setFrameShape(QFrame.Shape.NoFrame)
        self.messageTable.setLineWidth(0)
        self.messageTable.setAutoScrollMargin(0)
        self.messageTable.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        self.messageTable.setSelectionMode(QAbstractItemView.SelectionMode.NoSelection)
        self.messageTable.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        self.messageTable.setShowGrid(False)
        self.messageTable.setGridStyle(Qt.PenStyle.DotLine)
