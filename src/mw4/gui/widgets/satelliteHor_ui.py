...
class Ui_SatelliteHorizonDialog(object):
    def setupUi(self, SatelliteHorizonDialog):
        ...
        SatelliteHorizonDialog.setMinimumSize(QSize(0, 0))
        SatelliteHorizonDialog.setMaximumSize(QSize(16777215, 16777215))
    ...
    def retranslateUi(self, SatelliteHorizonDialog):
        ...
        self.satAzimuth.setToolTip(QCoreApplication.translate("SatelliteHorizonDialog", u"<html><head/><body><p>Actual azimuth of the satelite from observers position.</p></body></html>", None))
...
#if QT_CONFIG(tooltip)
        self.satAltitude.setToolTip(QCoreApplication.translate("SatelliteHorizonDialog", u"<html><head/><body><p>Actual altitude of the satelite from observers position.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.groupHorizon.setToolTip(QCoreApplication.translate("SatelliteHorizonDialog", u"<html><head/><body><p>Shows the visible track of the satellite when being observed from the position of the mount. </p></body></html>", None))
#endif // QT_CONFIG(tooltip)
