...
class Ui_SatelliteMapDialog(object):
    def setupUi(self, SatelliteMapDialog):
        ...
        SatelliteMapDialog.setMinimumSize(QSize(0, 0))
        SatelliteMapDialog.setMaximumSize(QSize(16777215, 16777215))
    ...
    def retranslateUi(self, SatelliteMapDialog):
        ...
        self.satLatitude.setToolTip(QCoreApplication.translate("SatelliteMapDialog", u"<html><head/><body><p>Actual latitude where the satellite could be seen in zenith.</p></body></html>", None))
...
#if QT_CONFIG(tooltip)
        self.satLongitude.setToolTip(QCoreApplication.translate("SatelliteMapDialog", u"<html><head/><body><p>Actual longitude where the satellite could be seen in zenith.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
