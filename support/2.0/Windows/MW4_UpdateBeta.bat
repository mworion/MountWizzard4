...
echo.
echo ---------------------------------------------
echo update script version 2.4
echo ---------------------------------------------

echo update script version 2.4 > update.log 2>&1
...
venv\Scripts\python -m pip install mountwizzard4 --pre --upgrade --no-cache-dir >> update.log 2>&1
