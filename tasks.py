...
def test_mw(c):
    ...
    runMW(c, 'flake8')
    runMW(c, 'pytest mw4/test/unit_tests/astrometry --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/base --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/cover --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/dome --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/environment --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/gui/extWindows --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/gui/mainWindow --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/gui/mainWmixin --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/gui/utilities --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/imaging --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/measure --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/modeldata --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/powerswitch --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/remote --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/telescope --cov-append --cov=mw4/ --cov-report=xml')
    runMW(c, 'pytest mw4/test/unit_tests/zStartup --cov-append --cov=mw4/ --cov-report=xml')
