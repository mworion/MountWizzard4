...
def test_mw(c):
    ...
    runMW(c, 'flake8')
    runMW(c, 'pytest mw4/test/unit_tests/astrometry --cov=mw4/')
    runMW(c, 'pytest mw4/test/unit_tests/base --cov-append --cov=mw4/')
    runMW(c, 'pytest mw4/test/unit_tests/cover --cov-append --cov=mw4/')
    runMW(c, 'pytest mw4/test/unit_tests/dome --cov-append --cov=mw4/')
    runMW(c, 'pytest mw4/test/unit_tests/environment --cov-append --cov=mw4/')
    ...
    runMW(c, 'pytest mw4/test/unit_tests/modeldata --cov-append --cov=mw4/')
    runMW(c, 'pytest mw4/test/unit_tests/powerswitch --cov-append --cov=mw4/')
    runMW(c, 'pytest mw4/test/unit_tests/remote --cov-append --cov=mw4/')
    runMW(c, 'pytest mw4/test/unit_tests/telescope --cov-append --cov=mw4/')
    runMW(c, 'pytest mw4/test/unit_tests/zStartup --cov-append --cov=mw4/')
