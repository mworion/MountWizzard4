...
def test_initConfig_2(function):
    ...
    function.app.config['videoW3'] = {'winPosX': 10000}
    suc = function.initConfig()
    assert suc
...
def test_initConfig_3(function):
    ...
    function.app.config['videoW3'] = {'winPosY': 10000}
    suc = function.initConfig()
    assert suc
...
def test_initConfig_4(function):
    ...
    function.app.config['videoW3']['winPosX'] = 100
    function.app.config['videoW3']['winPosY'] = 100
    suc = function.initConfig()
    assert suc
