...
def test_runSolveDone_0(function):
    mPoint = {"lenSequence": 3, "countSequence": 3, "pointNumber": 1}
    ...
    with mock.patch.object(function, "cancelRun"):
...
def test_runSolveDone_2(function):
    ...
    with mock.patch.object(function, "cycleThroughPointsFinished"):
        suc = function.runSolveDone(result)
        assert suc


def test_runSolveDone_3(function):
    mPoint = {"lenSequence": 3, "countSequence": 2, "imagePath": "", "pointNumber": 1}
    function.resultQueue.put(mPoint)
...
def test_runSolve_1(function):
    mPoint = {"lenSequence": 3, "countSequence": 2, "pointNumber": 1}
    function.slewQueue.put(mPoint)
    with mock.patch.object(function, "cancelRun"):
...
def test_runSolve_2(function):
    ...
    with mock.patch.object(function.app.plateSolve, "solve", return_value=False):
        suc = function.runSolve()
        assert not suc
...
def test_runSolve_3(function):
    ...
    function.solveQueue.put(mPoint)
    with mock.patch.object(function.app.plateSolve, "solve", return_value=True):
        suc = function.runSolve()
        assert suc
...
def test_cancelRun(function):
    with mock.patch.object(function, "restoreModelDefaultContextAndGuiStatus"):
        with mock.patch.object(function, "clearQueues"):
            with mock.patch.object(function, "restoreSignalsRunDefault"):
                with mock.patch.object(function.app.camera, "abort"):
                    with mock.patch.object(function.app.plateSolve, "abort"):
...
def test_cycleThroughPointsFinished_1(function):
    ...
    with mock.patch.object(function, "processDataAndFinishRun"):
...
def test_cycleThroughPointsFinished_2(function):
    ...
    with mock.patch.object(function, "processDataAndFinishRun"):
        with mock.patch.object(function, "runSlew"):
            suc = function.cycleThroughPointsFinished()
            assert suc
...
def test_cycleThroughPoints_1(function):
    points = [1, 2]
    with mock.patch.object(function, "setupSignalsForRun"):
        with mock.patch.object(function, "runSlew"):
