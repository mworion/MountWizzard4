...
def test_updateImageStats_2(function):
    function.app.dReg.drivers["camera"]["class"].data["CCD_INFO.CCD_PIXEL_SIZE_X"] = 1
    function.app.dReg.drivers["camera"]["class"].data["CCD_INFO.CCD_PIXEL_SIZE_Y"] = 1
    function.app.dReg.drivers["camera"]["class"].data["CCD_INFO.CCD_MAX_X"] = 100
    function.app.dReg.drivers["camera"]["class"].data["CCD_INFO.CCD_MAX_Y"] = 100
