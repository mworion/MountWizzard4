...
def test_addAlpha2ColorString_full_opacity(function):
    """Test addAlpha2ColorString with full opacity (transparency = 1.0)"""
    function.transparency = 1.0
    color = "#808080"
    result = function.addAlpha2ColorString(color)
    assert result == "#808080ff"


def test_addAlpha2ColorString_half_opacity(function):
    """Test addAlpha2ColorString with half opacity (transparency = 0.5)"""
    function.transparency = 0.5
    color = "#808080"
    result = function.addAlpha2ColorString(color)
    assert result == "#8080807f"


def test_addAlpha2ColorString_zero_opacity(function):
    """Test addAlpha2ColorString with zero opacity (transparency = 0.0)"""
    function.transparency = 0.0
    color = "#808080"
    result = function.addAlpha2ColorString(color)
    assert result == "#80808000"


def test_addAlpha2ColorString_various_colors_full_opacity(function):
    """Test addAlpha2ColorString with various colors at full opacity"""
    function.transparency = 1.0
    assert function.addAlpha2ColorString("#000000") == "#000000ff"
    assert function.addAlpha2ColorString("#ffffff") == "#ffffffff"
    assert function.addAlpha2ColorString("#ff0000") == "#ff0000ff"


def test_addAlpha2ColorString_various_colors_half_opacity(function):
    """Test addAlpha2ColorString with various colors at half opacity"""
    function.transparency = 0.5
    assert function.addAlpha2ColorString("#000000") == "#0000007f"
    assert function.addAlpha2ColorString("#ffffff") == "#ffffff7f"
    assert function.addAlpha2ColorString("#ff0000") == "#ff00007f"


def test_addAlpha2ColorString_quarter_opacity(function):
    """Test addAlpha2ColorString with quarter opacity (transparency = 0.25)"""
    function.transparency = 0.25
    color = "#808080"
    result = function.addAlpha2ColorString(color)
    assert result == "#8080803f"
