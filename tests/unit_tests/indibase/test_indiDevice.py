...
def test_getNumber_0(function):
    function.testNumberVec = {
        "propertyType": "defNumberVector",
        "elementList": {
            "test1": {
                "value": 10,
            },
...
def test_getText_0(function):
    function.testTextVec = {
        "propertyType": "defTextVector",
        "elementList": {
            "test1": {
                "value": "test",
            },
...
def test_getSwitch_0(function):
    function.testSwitchVec = {
        "propertyType": "defSwitchVector",
        "elementList": {
            "test1": {
                "value": "On",
            },
...
def test_getLight_0(function):
    function.testLightVec = {
        "propertyType": "defLightVector",
        "elementList": {
            "test1": {
                "value": "On",
            },
...
def test_getBlob_0(function):
    function.testBLOBVec = {
        "propertyType": "defBLOBVector",
        "elementList": {
            "testBLOBVec": {
                "value": "test",
            },
