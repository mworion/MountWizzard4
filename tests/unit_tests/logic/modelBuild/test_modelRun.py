...
def test_startNewSlew_3(function):
    ...
    with mock.patch.object(
        function.app.dReg.drivers["mount"].instance.obsSite,
        "setTargetAltAz",
        return_value=False,
    ):
        function.startNewSlew()
...
def test_startNewSlew_4(function):
    ...
    with (
        ...
        mock.patch.object(function.app.dReg.drivers["dome"].instance, "slewDome"),
        mock.patch.object(function.app.dReg.drivers["mount"].instance.obsSite, "startSlewing"),
    ):
        function.startNewSlew()
        assert not function.mountSlewed
        assert not function.domeSlewed
...
def test_addMountModelToBuildModel_1(function):
    function.app.dReg.drivers["mount"].instance.model.starList = [1, 2, 3]
...
def test_addMountModelToBuildModel_2(function):
    function.app.dReg.drivers["mount"].instance.model.starList = [1, 2]
    function.modelSaveData = [1, 2, 3]
    with (
        mock.patch.object(
            mw4.logic.modelBuild.modelRun, "writeRetrofitData", return_value=[1, 2, 3]
...
def test_collectBuildModelResults_2(function):
    jd = function.app.dReg.drivers["mount"].instance.obsSite.timeJD
    function.modelBuildData = {
        "im-00": {
            "altitude": Angle(degrees=0),
            "azimuth": Angle(degrees=0),
...
def test_startNewImageExposure_2(function, mocked_sleepAndEvents):
    ...
    with (
        ...
        mock.patch.object(function.app.dReg.drivers["camera"].instance, "expose"),
    ):
        function.startNewImageExposure()
...
def test_prepareModelBuildData_1(function):
    ...
    function.app.dReg.drivers["mount"].instance.setting.horizonLimitLow = 10
    function.app.dReg.drivers["mount"].instance.setting.horizonLimitHigh = 90
